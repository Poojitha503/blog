...
class UserController extends Controller
{
        ...
        public function googleLogin(Request $request)  {
            ...
            $gClient->setApplicationName("TEST322");
            $gClient->setClientId("518449300982-76srm11gffsdn6ag755ca4dbarhdce8l.apps.googleusercontent.com");
            $gClient->setClientSecret("6yD2mSo8dtRgum3zbJAKPUcu");
            $gClient->setRedirectUri($google_redirect_url);
            $gClient->setDeveloperKey("AIzaSyARHysewirZ1O0JK27kniRkIM0LDyYpuUU");
